...
export default {
  ...
  mounted() {
    ...
    // this.myimg1 = imgArr[0].myimg1;
    // this.myimg2 = imgArr[0].myimg2;
    // this.myimg3 = imgArr[0].myimg3;
  },
  components: {
    caipulist
  },
  methods: {
    ...
    autoplay() {
      ...
      index++;
      this.myimg1 = this.imgList[index].src;
      this.myimg2 = this.imgList[index - 1].src;
      this.myimg3 = this.imgList[index - 2].src;
    },
    toLeft() {
      if (index == 0) {
    ...
    goPage(e) {
      ...
      switch (e.target.innerHTML.trim()) {
        ...
        case "全部分类":
          this.left = 7;
          path = "/recip/caipuhome/caipulist?kind=全部分类";
          break;
        // 点击到空白部分不报错
        default:
