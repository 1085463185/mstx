      ...
      <div @click="goPage">
        <div class="myheader">
          ...
          <div class="headerbtn">
            ...
            <button :style="{color:left==4?'red':''}" type="button" class="listbtn">排行</button>
            <button :style="{color:left==5?'red':''}" type="button" class="listbtn">食材</button>
